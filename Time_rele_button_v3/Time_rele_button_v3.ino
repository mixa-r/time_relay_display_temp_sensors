...
//Шина I2C на ардуино нано пины A4/A5

//   ОБЪЯВЛЯЕМ КОНСТАНТЫ КОТОРЫЕ МОЖНО РЕДАКТИРОВАТЬ:                                         //
     const uint8_t   pinLedButton1   =             A0;
     const uint8_t   pinLedButton2   =             A1;
     const uint8_t   pinLedButton3   =             A2;
     const uint8_t   pinLedButton4   =             A6;
...
void setup(){                                                                                 //
     ...
     pinMode(pinLedButton4, OUTPUT);
     pinMode(pinButton1,  INPUT_PULLUP);                                                      //  Кнопка 1 с подтягивающим резистором
     pinMode(pinButton2,  INPUT_PULLUP);                                                      //  Кнопка 2 с подтягивающим резистором
     pinMode(pinButton3,  INPUT_PULLUP);                                                      //  Кнопка 3 с подтягивающим резистором
     pinMode(pinButton4,  INPUT_PULLUP);                                                      //  Кнопка 4 с подтягивающим резистором
...
void loop(){                                                                                  //
    ...
    int flagButton1 = 0;                                                                      //  Флаг состояния кнопки 1
    int flagButton2 = 0;                                                                      //  Флаг состояния кнопки 2
    int flagButton3 = 0;                                                                      //  Флаг состояния кнопки 3
    int flagButton4 = 0;                                                                      //  Флаг состояния кнопки 4

//************************Режим для 1 кнопки***********************************
  if(!digitalRead(pinButton1) == HIGH && flagButton1 == 0)      
    { delay(10);                                             
      digitalWrite(pinChanel_1, !digitalRead(pinChanel_1));
      digitalWrite(pinLedButton1, HIGH);
      flagButton1 = 1;
    }
  
  if(!digitalRead(pinButton1) == LOW && flagButton1 == 1)
    { delay(50);
      digitalWrite(pinLedButton1, LOW);
      flagButton1 = 0;
    } 
...
//************************Режим для 2 кнопки***********************************
  if(!digitalRead(pinButton2) == HIGH && flagButton2 == 0)      
    { delay(10);   
      digitalWrite(pinLedButton2, HIGH);                                          
  ...
  if(!digitalRead(pinButton2) == LOW && flagButton2 == 1)
    { delay(50);
      digitalWrite(pinLedButton2, LOW);
      flagButton2 = 0;
    }     
